...
bool interfaces__msg__object_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._object_info.ObjectInfo", full_classname_dest, 38) == 0);
  }
  interfaces__msg__ObjectInfo * ros_message = _ros_message;
  {  // class_name
  ...
  {  // box
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->box.data;
...
PyObject * interfaces__msg__object_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._object_info");
  ...
  {  // box
    ...
    if (ros_message->box.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->box.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->box.size * sizeof(int32_t));
      assert(data != NULL);
