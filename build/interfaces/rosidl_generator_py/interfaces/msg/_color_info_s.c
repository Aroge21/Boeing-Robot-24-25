...
bool interfaces__msg__color_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._color_info.ColorInfo", full_classname_dest, 36) == 0);
  }
  interfaces__msg__ColorInfo * ros_message = _ros_message;
  {  // color
...
PyObject * interfaces__msg__color_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._color_info");
