...
bool ros_robot_controller_msgs__msg__set_pwm_servo_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_robot_controller_msgs.msg._set_pwm_servo_state.SetPWMServoState", full_classname_dest, 67) == 0);
  }
  ros_robot_controller_msgs__msg__SetPWMServoState * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of SetPWMServoState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_robot_controller_msgs.msg._set_pwm_servo_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetPWMServoState");
