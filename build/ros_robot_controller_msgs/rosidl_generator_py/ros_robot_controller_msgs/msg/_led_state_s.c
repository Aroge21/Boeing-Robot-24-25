...
bool ros_robot_controller_msgs__msg__led_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_robot_controller_msgs.msg._led_state.LedState", full_classname_dest, 49) == 0);
  }
  ros_robot_controller_msgs__msg__LedState * ros_message = _ros_message;
  {  // id
...
PyObject * ros_robot_controller_msgs__msg__led_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_robot_controller_msgs.msg._led_state");
