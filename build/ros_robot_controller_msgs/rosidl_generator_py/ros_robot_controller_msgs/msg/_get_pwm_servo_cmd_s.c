...
bool ros_robot_controller_msgs__msg__get_pwm_servo_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_robot_controller_msgs.msg._get_pwm_servo_cmd.GetPWMServoCmd", full_classname_dest, 63) == 0);
  }
  ros_robot_controller_msgs__msg__GetPWMServoCmd * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of GetPWMServoCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_robot_controller_msgs.msg._get_pwm_servo_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPWMServoCmd");
