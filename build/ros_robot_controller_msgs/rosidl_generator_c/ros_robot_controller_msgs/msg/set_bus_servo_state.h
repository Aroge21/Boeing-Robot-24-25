...
#ifndef ROS_ROBOT_CONTROLLER_MSGS__MSG__SET_BUS_SERVO_STATE_H_
#define ROS_ROBOT_CONTROLLER_MSGS__MSG__SET_BUS_SERVO_STATE_H_
...
#endif  // ROS_ROBOT_CONTROLLER_MSGS__MSG__SET_BUS_SERVO_STATE_H_
