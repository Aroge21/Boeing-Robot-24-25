...
#ifndef ROS_ROBOT_CONTROLLER_MSGS__MSG__GET_PWM_SERVO_CMD_H_
#define ROS_ROBOT_CONTROLLER_MSGS__MSG__GET_PWM_SERVO_CMD_H_
...
#endif  // ROS_ROBOT_CONTROLLER_MSGS__MSG__GET_PWM_SERVO_CMD_H_
