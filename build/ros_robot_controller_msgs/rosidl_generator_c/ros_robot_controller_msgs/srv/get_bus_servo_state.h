...
#ifndef ROS_ROBOT_CONTROLLER_MSGS__SRV__GET_BUS_SERVO_STATE_H_
#define ROS_ROBOT_CONTROLLER_MSGS__SRV__GET_BUS_SERVO_STATE_H_
...
#endif  // ROS_ROBOT_CONTROLLER_MSGS__SRV__GET_BUS_SERVO_STATE_H_
